...
with open('images/brkthru-logo2.png', 'rb') as f:
    logo_bytes = f.read()
...
# Replace in assessments.html
for file_name in ['assessments.html', 'start-enneagram.html']:
...
print("Rebuilt assessments.html PDF engine with logo & async image decoding await")
