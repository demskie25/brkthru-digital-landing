...
for line in lines:
    ...
    if 'What Leaders Say About the Book' in line and not target_found:
...
if target_found:
    ...
    for i in range(len(updated_lines)):
        if 'What Leaders Say About the Book' in updated_lines[i]:
            updated_lines[i] = updated_lines[i].replace('What Leaders Say About the Book', 'Featured Experience & World Class Coach Book Testimonials')
            break
