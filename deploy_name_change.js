...
const logFile = 'e:/brkthru-digital-landing/deploy_name_change.txt';
...
run('git commit -m "UPDATE: Changed Meta-Programs Assessment to Enneagram Assessment in checkout"');
