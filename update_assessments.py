...
def final_assembly():
    ...
    # Backdoor Trigger on Heading
    # We also need to hide the accessDeniedOverlay and show appContent
    old_h1 = '<h1 class="text-4xl main-title text-center">Meta-Programs Assessment for Leaders</h1>'
    new_h1 = '<h1 @click="backdoorClicks++; if(backdoorClicks >= 6) { enneagramUnlocked = true; document.getElementById(\'accessDeniedOverlay\').classList.add(\'hidden\'); document.getElementById(\'appContent\').classList.remove(\'hidden\'); backdoorClicks = 0; }" class="text-4xl main-title text-center cursor-pointer select-none">Meta-Programs Assessment for Leaders</h1>'
