...
<body class="hero-gradient min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-7xl mx-auto w-full p-6 lg:p-12">
        <div class="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-5 sticky top-32">
                <div class="glass-card rounded-[2.5rem] p-10 lg:p-12 relative">
                    <!-- PROCESSING OVERLAY -->
                    <div id="processing-overlay">
                        <div class="w-16 h-16 border-4 border-blue-600 border-t-transparent rounded-full animate-spin mb-6"></div>
                        <h3 class="text-xl font-bold text-slate-900 mb-2">Secure Checkout Active</h3>
                        <p class="text-slate-500 text-sm mb-6">HitPay is open in a separate window.<br>Keep this page open to return after payment.</p>
                        <button onclick="hideOverlay()" class="text-xs font-bold text-blue-600 underline uppercase tracking-widest">Show Details Again</button>
                    </div>
                    ...
                    <div class="mt-10 space-y-6">
                        <button id="pay-btn" onclick="openSecureCheckout()" class="btn-premium">
                        ...
                        <div class="bg-blue-50/50 p-4 rounded-xl border border-blue-100/50">
                            <p class="text-[0.7rem] text-blue-800 leading-relaxed text-center font-medium">
                                <span class="font-bold text-blue-900">BRKTHRU COMMITMENT:</span> This will open HitPay in a secure popup window. You will NOT lose this page, and can return immediately after payment.
                            </p>
                        </div>
    ...
    <script>
        ...
        function openSecureCheckout() {
            if (!currentProductLink) return;
            
            // Show processing overlay on main site to provide visual continuity
            ...
            // Open HitPay in a dedicated popup window
            window.open(currentProductLink, 'SecureCheckout', 
...
console.log('SUCCESS: Written checkout popup flow to checkout.html and public/checkout.html');
