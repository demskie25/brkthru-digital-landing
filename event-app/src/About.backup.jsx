...
const TEAM = [
  { name: "Vanessa Salvaña", role: "Founding CEO, Lead Solution Designer", image: "/vanessa.jpg", bio: "Visionary leader and architectural mind behind Brkthru's systemic interventions." },
  ...
  { name: "Aldem Salvaña", role: "Chief Learning Head, Executive Meta-Coach", image: "/aldem.jpg", bio: "Leading expert in behavioral precision and designer of the WCC framework." }
];
    ...
    <div className="grid lg:grid-cols-2 gap-20 items-center">
      <div className="space-y-10">
        ...
        <p className="text-2xl text-slate-500 font-serif italic leading-relaxed">
          "In 1997, Aldem and Vanessa Salvaña launched a quiet revolution built on the high-stakes truth: You cannot facilitate a breakthrough in others that you have not first mastered in yourself."
        </p>
    ...
    <div className="col-span-12 lg:col-span-8 space-y-20 lg:border-r lg:border-slate-100 lg:pr-12">
      <div className="bg-slate-900 text-white rounded-[5rem] p-16 md:p-24 relative overflow-hidden shadow-2xl group">
        ...
        <div className="relative z-10 space-y-12">
          ...
          <p className="text-slate-400 text-2xl font-serif leading-relaxed italic pr-8">"Engineering high-performance for the 'Whole Leader'—consistent across personal mindset, corporate strategy, and family legacy."</p>
      ...
      <nav className="fixed top-0 left-0 right-0 h-32 bg-white/80 backdrop-blur-3xl z-[100] border-b border-slate-100 flex items-center shadow-sm">
        <div className="max-w-7xl mx-auto px-12 w-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 cursor-pointer group" onClick={() => navigate('home')}>
            <img src="images/brkthru-logo.png" alt="Brkthru" className="h-10 md:h-12 w-auto transition-transform group-hover:scale-105" onError={(e) => { e.currentTarget.style.display='none'; }} />
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-24 items-start pb-20 border-b border-white/5">
          <div className="space-y-12">
            <div className="flex items-center gap-6">
               <img src="images/brkthru-logo.png" alt="Logo" className="h-10 invert opacity-80" />
          ...
          <div className="flex flex-col md:items-end gap-20 text-[11px] font-black uppercase tracking-[0.5em] text-slate-400 font-sans">
             <div className="flex flex-wrap gap-12 font-bold">
               ...
               <a href="mailto:brkthrucares@gmail.com" className="hover:text-amber-500 transition-colors">Strategic Contact</a>
               <a href="tel:+639158766595" className="hover:text-amber-500 transition-colors">+63915 876 6595</a>
